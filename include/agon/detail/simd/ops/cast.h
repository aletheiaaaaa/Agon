  ...
  inline T cast(F v) {
    ...
    if constexpr (std::is_same_v<F, VecI8<arch>>) {
      if constexpr (std::is_same_v<T, VecI16<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI8<AVX512>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI16<AVX512>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF64<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF32<AVX512>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF64<AVX512>");
      }
    }
    else {
  ...
  inline T cast(F v) {
    ...
    if constexpr (std::is_same_v<F, VecI8<arch>>) {
      if constexpr (std::is_same_v<T, VecI16<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI8<AVX2>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI16<AVX2>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF64<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF32<AVX2>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF64<AVX2>");
      }
    }
    else {
  ...
  inline T cast(F v) {
    ...
    if constexpr (std::is_same_v<F, VecI8<arch>>) {
      if constexpr (std::is_same_v<T, VecI16<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI8<SSE4_1>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI16<SSE4_1>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF64<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF32<SSE4_1>");
      }
    }
      ...
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF64<SSE4_1>");
      }
    }
    else {
  ...
  inline T cast(F v) {
    ...
    if constexpr (std::is_same_v<F, VecI8<arch>>) {
      if constexpr (std::is_same_v<T, VecI16<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI8<GENERIC>");
      }
    }
    else if constexpr (std::is_same_v<F, VecI16<arch>>) {
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecI16<GENERIC>");
      }
    }
    else if constexpr (std::is_same_v<F, VecF32<arch>>) {
      if constexpr (std::is_same_v<T, VecF64<arch>>) {
        ...
        return T(static_cast<int16_t>(std::lround(v.data)));
      } else if constexpr (std::is_same_v<T, VecI8<arch>>) {
        return T(static_cast<int8_t>(std::lround(v.data)));
      } else {
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF32<GENERIC>");
      }
    }
    else if constexpr (std::is_same_v<F, VecF64<arch>>) {
      if constexpr (std::is_same_v<T, VecF32<arch>>) {
        ...
        static_assert(std::is_same_v<T, void>, "Unsupported cast from VecF64<GENERIC>");
      }
    }
    else {
