...
namespace agon::optim {
  ...
  template class SGD<std::tuple<Parameter<float>>>;
  template class SGD<std::tuple<Parameter<double>>>;
  template class SGD<std::tuple<Parameter<float>, Parameter<double>>>;
}
